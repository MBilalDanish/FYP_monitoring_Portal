        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="rounded-0 modal-content">
            <div class="modal-header">
              ...
              <button
                type="button"
                class="rounded-0 bg-warning close"
                data-dismiss="modal"
                aria-label="Close"
              >
            ...
            <form @submit.prevent="editmode ? updateStudents():createStudent()">
              <div class="modal-body">
                ...
                <div class="form-group row">
                  <label class="col-md-2 col-form-label text-md-right text-dark">
  ...
  methods: {
    sendEmailLink() {
      axios
        ...
        .then(() => {
          swal.fire(
            "Email Confirmation Link is sent to your Email.",
            "Verify your account and Refresh the page",
            "success"
          );
        })
        .catch(() => {
